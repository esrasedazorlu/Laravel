                            ...
                            <div class="single-para simpleCart_shelfItem">
                                ...
                                <ul class="tag-men">
                                    <li><span>Kategori: </span>
                                        <span style="margin-left: 10rem" class="women1">: {{\App\Models\Kategoriler::getField($data[0]['kategoriid'],"name")}}</span></li>
                                    <li><span>Yayin Evi: </span>
                                        <span style="margin-left: 9.5rem"  class="women1">: {{\App\Models\YayinEvi::getField($data[0]['yayineviid'],"name")}} </span></li>
                                    <li><span>Yazarı: </span>
                                        <span style="margin-left: 11rem"  class="women1">: {{\App\Models\Yazarlar::getField($data[0]['yazarid'],"name")}}</span></li>
                                </ul>
                        ...
                        <div class="product-one">
                            ...
                            <div class="col-md-4 product-left p-left">
                                <div class="product-main simpleCart_shelfItem">
                                    <a href="{{route('kitap.detay',['selflink'=>$value['selflink']])}}" class="mask"><img class="img-responsive zoom-img" src="{{asset((\App\Helper\mHelper::largeImage(($value['image']))))}}" alt="" /></a>
