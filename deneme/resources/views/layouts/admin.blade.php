...
<script src="{{asset('admin_css/assets/js/jquery-3.2.1.min.js')}}"></script>
<script src="{{asset('admin_css/assets/js/bootstrap.min.js')}}"></script>
...
<script src="{{asset('admin_css/assets/js/material-dashboard.js')}}"></script>
